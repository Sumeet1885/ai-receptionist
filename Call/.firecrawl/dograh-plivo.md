...
[Skip to main content](https://docs.dograh.com/integrations/telephony/plivo#content-area)

## [​](https://docs.dograh.com/integrations/telephony/plivo\#overview)  Overview
...
## [​](https://docs.dograh.com/integrations/telephony/plivo\#prerequisites)  Prerequisites
...
## [​](https://docs.dograh.com/integrations/telephony/plivo\#configuration)  Configuration

### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-1-get-plivo-credentials)  Step 1: Get Plivo Credentials
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-2-configure-in-dograh-ai)  Step 2: Configure in Dograh AI

1. Navigate to **/telephony-configurations** and click **Add configuration**
2. Select **Plivo** as your provider
3. Enter your credentials:   - Auth ID
   - Auth Token
   - Application ID — _optional_. Leave blank and Dograh will auto-create a Plivo Application on save (with the `answer_url` already configured) and store its Application ID on this configuration.
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-3-test-your-configuration)  Step 3: Test Your Configuration

1. Create a test workflow
2. Click “Call” to verify connection
3. Check call logs for successful connection

## [​](https://docs.dograh.com/integrations/telephony/plivo\#inbound-calling-setup)  Inbound Calling Setup
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-1-link-the-phone-number-to-your-plivo-application)  Step 1: Link the Phone Number to Your Plivo Application
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-2-assign-an-inbound-workflow-to-the-phone-number-in-dograh)  Step 2: Assign an Inbound Workflow to the Phone Number in Dograh
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-3-verify-the-answer-url-on-the-plivo-application)  Step 3: Verify the Answer URL on the Plivo Application
...
### [​](https://docs.dograh.com/integrations/telephony/plivo\#step-4-verify-setup)  Step 4: Verify Setup

- Ensure your Dograh AI instance is publicly accessible
- Verify any firewalls allow Plivo’s IP ranges

### [​](https://docs.dograh.com/integrations/telephony/plivo\#test-inbound-calling)  Test Inbound Calling
...
## [​](https://docs.dograh.com/integrations/telephony/plivo\#troubleshooting)  Troubleshooting
...
## [​](https://docs.dograh.com/integrations/telephony/plivo\#best-practices)  Best Practices
...
[Vonage Integration](https://docs.dograh.com/integrations/telephony/vonage) [Telnyx Integration](https://docs.dograh.com/integrations/telephony/telnyx)
