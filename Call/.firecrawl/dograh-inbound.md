> ## Documentation Index
>
> Fetch the complete documentation index at: [/llms.txt](https://docs.dograh.com/llms.txt)
>
> Use this file to discover all available pages before exploring further.

[Skip to main content](https://docs.dograh.com/integrations/telephony/inbound#content-area)

## [​](https://docs.dograh.com/integrations/telephony/inbound\#overview)  Overview
...
## [​](https://docs.dograh.com/integrations/telephony/inbound\#supported-providers-for-inbound-calls)  Supported Providers for Inbound Calls

[**Twilio** \\
\\
Industry-leading platform with robust inbound call handling](https://docs.dograh.com/integrations/telephony/twilio)

[**Vonage** \\
\\
Application-level inbound routing with high-quality 16kHz audio](https://docs.dograh.com/integrations/telephony/vonage)

[**Plivo** \\
\\
Application-level inbound routing on Plivo’s global voice cloud](https://docs.dograh.com/integrations/telephony/plivo)

[**Telnyx** \\
\\
Application-level inbound via Telnyx Call Control API](https://docs.dograh.com/integrations/telephony/telnyx)

[**Cloudonix** \\
\\
SIP-based inbound calling with flexible trunk configuration](https://docs.dograh.com/integrations/telephony/cloudonix)

[**Vobiz** \\
\\
Cloud-based telephony with global reach and competitive pricing](https://docs.dograh.com/integrations/telephony/vobiz)

[**Asterisk ARI** \\
\\
Connect to your own Asterisk PBX via the Asterisk REST Interface](https://docs.dograh.com/integrations/telephony/asterisk-ari)

## [​](https://docs.dograh.com/integrations/telephony/inbound\#how-inbound-calling-works)  How Inbound Calling Works
...
## [​](https://docs.dograh.com/integrations/telephony/inbound\#configuration-in-dograh-ai)  Configuration in Dograh AI

Setting up inbound calling takes three steps:

### [​](https://docs.dograh.com/integrations/telephony/inbound\#step-1-configure-telephony-provider)  Step 1: Configure Telephony Provider
...
- [Twilio Configuration](https://docs.dograh.com/integrations/telephony/twilio#configuration)
- [Vonage Configuration](https://docs.dograh.com/integrations/telephony/vonage#configuration)
- [Plivo Configuration](https://docs.dograh.com/integrations/telephony/plivo#configuration)
- [Telnyx Configuration](https://docs.dograh.com/integrations/telephony/telnyx#configuration)
- [Cloudonix Configuration](https://docs.dograh.com/integrations/telephony/cloudonix#configuration)
- [Vobiz Configuration](https://docs.dograh.com/integrations/telephony/vobiz#configuration)
- [Asterisk ARI Configuration](https://docs.dograh.com/integrations/telephony/asterisk-ari#configuration-in-dograh)

### [​](https://docs.dograh.com/integrations/telephony/inbound\#step-2-assign-an-inbound-workflow-to-the-phone-number)  Step 2: Assign an Inbound Workflow to the Phone Number
...
### [​](https://docs.dograh.com/integrations/telephony/inbound\#step-3-point-your-provider-at-/inbound/run)  Step 3: Point Your Provider at `/inbound/run`
...
- [Twilio Inbound Setup](https://docs.dograh.com/integrations/telephony/twilio#inbound-calling-setup)
- [Vonage Inbound Setup](https://docs.dograh.com/integrations/telephony/vonage#inbound-calling-setup)
- [Plivo Inbound Setup](https://docs.dograh.com/integrations/telephony/plivo#inbound-calling-setup)
- [Telnyx Inbound Setup](https://docs.dograh.com/integrations/telephony/telnyx#inbound-calling-setup)
- [Cloudonix Inbound Setup](https://docs.dograh.com/integrations/telephony/cloudonix#inbound-calling-setup)
- [Vobiz Inbound Setup](https://docs.dograh.com/integrations/telephony/vobiz#inbound-calling-setup)
- [Asterisk ARI Inbound Setup](https://docs.dograh.com/integrations/telephony/asterisk-ari#inbound-calling)

## [​](https://docs.dograh.com/integrations/telephony/inbound\#testing-inbound-calls)  Testing Inbound Calls
...
## [​](https://docs.dograh.com/integrations/telephony/inbound\#troubleshooting-common-issues)  Troubleshooting Common Issues
...
## [​](https://docs.dograh.com/integrations/telephony/inbound\#best-practices)  Best Practices
...
## [​](https://docs.dograh.com/integrations/telephony/inbound\#next-steps)  Next Steps
...
[Telephony Integration](https://docs.dograh.com/integrations/telephony/overview) [Twilio Integration](https://docs.dograh.com/integrations/telephony/twilio)
